...
// game's author
#define AUTHOR "Mykolas Krupauskas"
...
// initial digits color
#define FG_CORRECT COLOR_GREEN
#define BG_CORRECT COLOR_BLACK

// nicknames for pairs of colors
enum { PAIR_BANNER = 1, PAIR_GRID, PAIR_BORDER, PAIR_LOGO, PAIR_DIGITS, PAIR_CORRECT };
